...
public final class ActivitySubBinding implements ViewBinding {
  ...
  private ActivitySubBinding(@NonNull ConstraintLayout rootView, @NonNull Button closeButton,
  ...
  public static ActivitySubBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySubBinding((ConstraintLayout) rootView, closeButton, textView);
    }
